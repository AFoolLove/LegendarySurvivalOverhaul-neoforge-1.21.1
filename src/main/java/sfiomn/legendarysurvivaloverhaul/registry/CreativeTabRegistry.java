...
public class CreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> LEGENDARY_CREATURES_TAB = ITEM_GROUPS.register("legendary_creatures", () -> CreativeModeTab.builder()
