...
public class ContainerRegistry {
    public static final DeferredRegister<MenuType<?>> CONTAINERS =
            DeferredRegister.create(BuiltInRegistries.MENU, LegendarySurvivalOverhaul.MOD_ID);

    public static final DeferredHolder<MenuType<?>, MenuType<AbstractThermalContainer>> COOLER_CONTAINER
            = CONTAINERS.register("cooler_container", () -> IMenuTypeExtension.create(CoolerContainer::new));

    public static final DeferredHolder<MenuType<?>, MenuType<AbstractThermalContainer>> HEATER_CONTAINER
