...
public class LegendarySurvivalOverhaul {
    ...
    public LegendarySurvivalOverhaul(IEventBus modBus, ModContainer container) {
        ...
        modBus.addListener(RegisterPayloadHandlersEvent.class, NetworkHandler::register);
        modBus.addListener(RegisterCapabilitiesEvent.class, ModCapabilities::attachCapabilityPlayer);
        ...
        AttributeTypeRegistry.register(modBus);
...
//        }1
    ...
    private void registerBrewingRecipes(RegisterBrewingRecipesEvent event) {
        if (Config.Baked.temperatureEnabled)
            MobEffectRegistry.registerBrewingRecipes(event);
    }
