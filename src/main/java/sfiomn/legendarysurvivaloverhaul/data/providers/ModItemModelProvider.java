...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        for (int i=0; i<30; i++) {
            ...
            singleTexture("item/thermometer/thermometer_" + jsonName, ResourceLocation.withDefaultNamespace("item/generated"),
        ...
        for (int i=1; i<4; i++) {
            for (String season: serene_seasons) {
                ...
                singleTexture("item/seasonal_calendar/serene_seasons/seasonal_calendar_" + jsonName, ResourceLocation.withDefaultNamespace("item/generated"),
        ...
        for (int i=1; i<7; i++) {
            for (String season: ecliptic_seasons) {
                String jsonName = season + i;
                singleTexture("item/seasonal_calendar/ecliptic_seasons/seasonal_calendar_" + jsonName, ResourceLocation.withDefaultNamespace("item/generated"),
        ...
        singleTexture("item/seasonal_calendar/seasonal_calendar_null", ResourceLocation.withDefaultNamespace("item/generated"),
