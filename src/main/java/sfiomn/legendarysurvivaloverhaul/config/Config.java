...
public class Config
{
	...
	public static void register(ModContainer container)
	{
		...
		container.registerConfig(ModConfig.Type.CLIENT, CLIENT_SPEC, LegendarySurvivalOverhaul.MOD_ID + "/" + LegendarySurvivalOverhaul.MOD_ID + "-client.toml");
		container.registerConfig(ModConfig.Type.COMMON, COMMON_SPEC, LegendarySurvivalOverhaul.MOD_ID + "/" + LegendarySurvivalOverhaul.MOD_ID +"-common.toml");
	...
	{
		return obj instanceof final String entityName && BuiltInRegistries.MOB_EFFECT.containsKey(ResourceLocation.parse(entityName));
	}
