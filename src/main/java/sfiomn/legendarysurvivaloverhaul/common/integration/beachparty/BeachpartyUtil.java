...
//    }
    ...
    public static boolean canProvideShade(@Nonnull ResourceLocation itemRegistryName) {
        return false && LegendarySurvivalOverhaul.beachpartyLoaded && (itemRegistryName.toString().equals("beachparty:hooded_beach_chair") || itemRegistryName.toString().equals("beachparty:beach_parasol"));
    }
}
